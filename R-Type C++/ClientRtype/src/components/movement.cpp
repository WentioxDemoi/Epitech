...
component::Movement::Movement()
{
    _v = 2.5;
    _a = 1;
    key_tab[0].push_back(sf::Keyboard::Up);
    key_tab[0].push_back(sf::Keyboard::Down);
    key_tab[0].push_back(sf::Keyboard::Left);
    key_tab[0].push_back(sf::Keyboard::Right);
    key_tab[1].push_back(sf::Keyboard::Z);
    key_tab[1].push_back(sf::Keyboard::S);
    key_tab[1].push_back(sf::Keyboard::Q);
    key_tab[1].push_back(sf::Keyboard::D);
}
...
void component::Movement::manage_input(Entity e, std::vector<Entity> tab_e, int e_count, int which_keyboard)
{
    for (int i = e_keys::k_up; i != e_keys::k_d; i++) {
        if ((sf::Keyboard::isKeyPressed(key_tab[which_keyboard][0]))
            ...
            this->move_y(e, -1);
        if ((sf::Keyboard::isKeyPressed(key_tab[which_keyboard][1]))
            ...
            this->move_y(e, 1);
        if ((sf::Keyboard::isKeyPressed(key_tab[which_keyboard][2]))
            ...
            this->move_x(e, -1);
        if ((sf::Keyboard::isKeyPressed(key_tab[which_keyboard][3]))
